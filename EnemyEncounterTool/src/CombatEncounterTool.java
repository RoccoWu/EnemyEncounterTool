...
public class CombatEncounterTool {
   ...
   /* public CombatEncounterTool(BFF bff, ArrayList<CombatEncounter> combatEncounter, MainMenu mainMenu) {
    ...
    public static void main(String[] args) {
        ...
        enemyDefinitions = new HashMap<EnemyType, EnemyBehaviorComponent>();
        //THUG LEVEL 1
    ...
    public void createCombatEncounter()
    {
        ...
        while(ceSize <1 || ceSize > maxEnemiesInCounter) //runs the following until the system gets the correct input
        {
            ...
            for(int i = 1; i<= ceSize; i++)
            {
                ...
                {
                    case THUGLEVEL1:
                        newCombatEncounter.addEnemy(enemyDefinitions.get(EnemyType.THUGLEVEL1));
                    ...
                    case THUGLEVEL2:
                        newCombatEncounter.addEnemy(enemyDefinitions.get(EnemyType.THUGLEVEL2));
                        ...
                        break;
                    case THUGLEVEL3:
                        newCombatEncounter.addEnemy(enemyDefinitions.get(EnemyType.THUGLEVEL3));
                        ...
                        break;
                    case TANKTHUG:
                        newCombatEncounter.addEnemy(enemyDefinitions.get(EnemyType.TANKTHUG));
                        ...
                        break;
                    case AGILETHUG:
                        newCombatEncounter.addEnemy(enemyDefinitions.get(EnemyType.AGILETHUG));
                        ...
                        break;
                    case KNIFETHUG:
                        newCombatEncounter.addEnemy(enemyDefinitions.get(EnemyType.KNIFETHUG));
                        ...
                        break;
                    case SHIELDTHUG:
                        newCombatEncounter.addEnemy(enemyDefinitions.get(EnemyType.SHIELDTHUG));
                        ...
                        break;
                    case BOSS:
                        newCombatEncounter.addEnemy(enemyDefinitions.get(EnemyType.BOSS));
    ...
    public void lookUpEnemyTypes()
    {
        ...
        bff.print(enemyDefinitions.get(enemyToView).toString());
        bff.printFancy(mainMenu.getMenuString());
    }
